...
1. Stel op Vercel server-side in: `ANTHROPIC_API_KEY`, `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `BOT_SESSION_SECRET` (minimaal 32 willekeurige tekens). Zet geen service-role-key in de frontend.
